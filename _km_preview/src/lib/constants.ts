...
export const APP_NAME = "منصة إدارة المعرفة والامتثال";
...
export const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  // متعلّم المنصّة: لا صلاحيات على النظام الإداري. تصفّح الأكاديمية/الفيديو عام،
  // والتسجيل في الدورات مرتبط بالجلسة فقط — مفصول تماماً عن صلاحيات مدير النظام.
  LEARNER: [],
};
